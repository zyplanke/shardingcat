package io.shardingcat.statistic.stat;
...
//	private ReentrantReadWriteLock lock  = new ReentrantReadWriteLock();
	...
	public UserStat(String user) {
		...
		int size = ShardingCatServer.getInstance().getConfig().getSystem().getSqlRecordCount();
...
//        try {
			...
			//记录超过阈值的大结果集sql
			if(rseultSetSize>=ShardingCatServer.getInstance().getConfig().getSystem().getMaxResultSet()){
