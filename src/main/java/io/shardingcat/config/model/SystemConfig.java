...
public final class SystemConfig {
	...
	/*
	 * 注意！！！ 目前shardingcat支持的MySQL版本，如果后续有新的MySQL版本,请添加到此数组， 对于MySQL的其他分支，
	...
	private String sqlInterceptor = "io.shardingcat.server.interceptor.impl.DefaultSqlInterceptor";
	...
	private int shardingcatNodeId=1;
	...
	/**
	 * ShardingCat 使用 Off Heap For Merge/Order/Group/Limit计算相关参数
	 */
	...
	public static String getHomePath() {
		...
		// SHARDINGCAT_HOME为空，默认尝试设置为当前目录或上级目录。BEN
		if(home == null) {
			try {
	...
	public int getShardingCatNodeId() {
		return shardingcatNodeId;
	}

	public void setShardingCatNodeId(int shardingcatNodeId) {
		this.shardingcatNodeId = shardingcatNodeId;
	}
	...
	public String toString() {
		return "SystemConfig [processorBufferLocalPercent="
				...
				+ ", shardingcatNodeId=" + shardingcatNodeId + "]";
	}
