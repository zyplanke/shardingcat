...
import io.shardingcat.config.loader.zkprocess.console.ParseParamEnum;
import io.shardingcat.config.loader.zkprocess.entity.Property;
import io.shardingcat.config.loader.zkprocess.entity.Rules;
import io.shardingcat.config.loader.zkprocess.entity.rule.function.Function;
import io.shardingcat.config.loader.zkprocess.entity.rule.tablerule.TableRule;
...
import io.shardingcat.config.loader.zkprocess.parse.entryparse.rule.json.FunctionJsonParse;
import io.shardingcat.config.loader.zkprocess.parse.entryparse.rule.json.TableRuleJsonParse;
import io.shardingcat.config.loader.zkprocess.parse.entryparse.rule.xml.RuleParseXmlImpl;
...
public class RuleszkToxmlLoader extends ZkMultLoader implements NotiflyService {
    ...
    */
    ...
    public boolean notiflyProcess() throws Exception {
        ...
        if (ShardingCatServer.getInstance().getProcessors() != null)
            ReloadConfig.reload();
