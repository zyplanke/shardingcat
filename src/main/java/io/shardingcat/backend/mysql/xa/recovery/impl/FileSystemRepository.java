package io.shardingcat.backend.mysql.xa.recovery.impl;

import io.shardingcat.ShardingCatServer;
import io.shardingcat.backend.mysql.xa.*;
import io.shardingcat.backend.mysql.xa.recovery.*;
...
//        String baseName = configProperties.getLogBaseName();
        ...
        SystemConfig systemConfig = shardingcatconfig.getSystem();
