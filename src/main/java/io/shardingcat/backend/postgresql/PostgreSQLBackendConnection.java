...
import io.shardingcat.backend.jdbc.ShowVariables;
import io.shardingcat.backend.mysql.CharsetUtil;
import io.shardingcat.backend.mysql.nio.MySQLConnectionHandler;
import io.shardingcat.backend.mysql.nio.handler.ResponseHandler;
import io.shardingcat.backend.postgresql.packet.Query;
import io.shardingcat.backend.postgresql.packet.Terminate;
import io.shardingcat.backend.postgresql.utils.PIOUtils;
import io.shardingcat.backend.postgresql.utils.PacketUtils;
import io.shardingcat.backend.postgresql.utils.PgSqlApaterUtils;
...
import io.shardingcat.util.exception.UnknownTxIsolationException;
...
public class PostgreSQLBackendConnection extends BackendAIOConnection {
	...
	public void execute(RouteResultsetNode rrn, ServerConnection sc, boolean autocommit) throws IOException {	
		...
		//FIX BUG  https://github.com/ShardingCatApache/ShardingCat-Server/issues/1185
