...
import io.shardingcat.net.handler.LoadDataInfileHandler;
...
public final class ServerLoadDataInfileHandler implements LoadDataInfileHandler
{
    ...
    public void start(String sql)
    {
        ...
        schema = ShardingCatServer.getInstance().getConfig()
                .getSchemas().get(serverConnection.getSchema());
        tableId2DataNodeCache = (LayerCachePool) ShardingCatServer.getInstance().getCacheService().getCachePool("TableID2DataNodeCache");
