package io.shardingcat.server.util;
...
public class SchemaUtil
{
    public static SchemaInfo parseSchema(String sql)
    {
      ...
      return parseTables(parser.parseStatement(),new ShardingCatSchemaStatVisitor()  );
    }
    public static String detectDefaultDb(String sql, int type)
    {
        String db=null;
        Map<String, SchemaConfig> schemaConfigMap = ShardingCatServer.getInstance().getConfig()
                .getSchemas();
