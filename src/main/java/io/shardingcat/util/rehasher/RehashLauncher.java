package io.shardingcat.util.rehasher;
...
import io.shardingcat.route.function.PartitionByMod;
import io.shardingcat.route.function.PartitionByMurmurHash;
import io.shardingcat.util.CollectionUtil;
import io.shardingcat.util.exception.RehashException;

/**
 * 本工具依赖druid，ShardingCat已经包含druid，druid配置请查阅相关文档。相关参数请看RehashCmdArgs
 * @author wujingrun
 *
 */
