...
import io.shardingcat.memory.unsafe.utils.sort.UnsafeKVExternalSorter;
...
public final class UnsafeFixedWidthAggregationMap {
  ...
  public UnsafeKVExternalSorter destructAndCreateExternalSorter() throws IOException {
    return new UnsafeKVExternalSorter(
      ...
      ShardingCatServer.getInstance().getShardingCatMemory().getBlockManager(),
      ShardingCatServer.getInstance().getShardingCatMemory().getSerializerManager(),
