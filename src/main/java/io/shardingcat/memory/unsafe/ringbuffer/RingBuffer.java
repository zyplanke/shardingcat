package io.shardingcat.memory.unsafe.ringbuffer;


import io.shardingcat.memory.unsafe.Platform;
import io.shardingcat.memory.unsafe.memory.mm.MemoryConsumer;
import io.shardingcat.memory.unsafe.ringbuffer.common.Cursored;
import io.shardingcat.memory.unsafe.ringbuffer.common.event.*;
import io.shardingcat.memory.unsafe.ringbuffer.exception.InsufficientCapacityException;
import io.shardingcat.memory.unsafe.ringbuffer.producer.Sequencer;
...
public class RingBuffer<E extends MemoryConsumer> implements Cursored, EventSequencer<E>, EventSink<E> {
    ...
    /**
     * @see io.shardingcat.memory.unsafe.ringbuffer.common.DataProvider#get(long)
     */
    @Override
    ...
    /**
     * @see io.shardingcat.memory.unsafe.ringbuffer.common.event.EventSink#publishEvent(EventTranslator)
     */
    @Override
    ...
    /**
     * @see io.shardingcat.memory.unsafe.ringbuffer.common.event.EventSink#tryPublishEvent(EventTranslator)
     */
    @Override
