package io.shardingcat.memory.unsafe.utils;
 ...
 */
public class ShardingCatPropertyConf {

    private ConcurrentHashMap settings = new ConcurrentHashMap<String, String>();

    public ShardingCatPropertyConf(){

    }

    /** Set a configuration variable. */
    public ShardingCatPropertyConf set(String key, String value) {
        set(key, value, false);
        return  this;
    }


    public ShardingCatPropertyConf set(String key, String value, boolean silent){
