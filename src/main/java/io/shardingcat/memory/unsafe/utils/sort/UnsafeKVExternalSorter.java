...
import io.shardingcat.memory.unsafe.map.BytesToBytesMap;
 ...
 *
 * Note that this class allows optionally passing in a {@link io.shardingcat.memory.unsafe.map.BytesToBytesMap} directly in order
