...
public final class UnsafeExternalSorter extends MemoryConsumer {
  ...
  private UnsafeExternalSorter(
    ...
    if(ShardingCatServer.getInstance().getShardingCatMemory() != null){
         this.fileBufferSizeBytes = (int) ShardingCatServer.getInstance().
              getShardingCatMemory().getConf().getSizeAsBytes("shardingcat.merge.file.buffer", "32k");
    }else{
