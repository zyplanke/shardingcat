...
import io.shardingcat.sqlengine.mpp.RowDataPacketSorter;
...
public final class UnsafeExternalRowSorter {
  ...
  public UnsafeExternalRowSorter(DataNodeMemoryManager dataNodeMemoryManager,
                                 @Nonnull ShardingCatMemory shardingCatMemory,
                                 StructType schema,
    ...
    sorter = UnsafeExternalSorter.create(
            ...
            shardingCatMemory.getBlockManager(),
           shardingCatMemory.getSerializerManager(),
            recordComparator,
      prefixComparator,
      shardingCatMemory.getConf().getSizeAsBytes("shardingcat.pointer.array.len","1K"),
      pageSizeBytes,
      canUseRadixSort,
      enableSort);
  }
