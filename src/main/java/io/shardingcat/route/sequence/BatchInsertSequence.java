package io.shardingcat.route.sequence;

import io.shardingcat.route.sequence.handler.*;
		...
		try {
			...
			if(insert.getValuesList()!=null){
				...
				if(sequenceHandler == null){
					int seqHandlerType = ShardingCatServer.getInstance().getConfig().getSystem().getSequnceHandlerType();
