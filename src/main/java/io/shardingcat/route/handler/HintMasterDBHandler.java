...
/**
 * 处理情况 sql hint: shardingcat:db_type=master/slave<br/>
 * 后期可能会考虑增加 shardingcat:db_type=slave_newest，实现走延迟最小的slave
 * @author digdeep@126.com
 */
// /*#shardingcat:db_type=master*/
// /*#shardingcat:db_type=slave*/
// /*#shardingcat:db_type=slave_newest*/
