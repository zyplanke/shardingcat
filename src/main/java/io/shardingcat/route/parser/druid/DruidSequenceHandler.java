...
import io.shardingcat.route.sequence.handler.IncrSequencePropHandler;
...
public class DruidSequenceHandler {
    ...
    /**
     * 获取SHARDINGCAT SEQ的匹配语句
     */
    private final static String MATCHED_FEATURE = "NEXT VALUE FOR SHARDINGCATSEQ_";
    ...
    public DruidSequenceHandler(int seqHandlerType) {
        switch (seqHandlerType) {
            ...
            case SystemConfig.SEQUENCEHANDLER_ZK_DISTRIBUTED:
                sequenceHandler = DistributedSequenceHandler.getInstance(ShardingCatServer.getInstance().getConfig().getSystem());
                break;
