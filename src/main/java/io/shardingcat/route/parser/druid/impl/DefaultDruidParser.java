...
import io.shardingcat.sqlengine.mpp.RangeValue;
...
public class DefaultDruidParser implements DruidParser {
	...
	/**
	 * 使用ShardingCatSchemaStatVisitor解析,得到tables、tableAliasMap、conditions等
	 * @param schema
	 * @param stmt
	 */
	public void parser(SchemaConfig schema, RouteResultset rrs, SQLStatement stmt, String originSql,LayerCachePool cachePool,ShardingCatSchemaStatVisitor schemaStatVisitor) throws SQLNonTransientException {
	 ...
	 * @return
	 */
	public boolean afterVisitorParser(RouteResultset rrs, SQLStatement stmt,ShardingCatSchemaStatVisitor schemaStatVisitor){
		return false;
	}
