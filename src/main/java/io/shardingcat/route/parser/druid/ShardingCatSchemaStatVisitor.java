 ...
 *
 */
public class ShardingCatSchemaStatVisitor extends MySqlSchemaStatVisitor {
...
//            }
    ...
    private void setSubQueryRelationOrFlag(SQLExprImpl x){
    	ShardingCatSubQueryVisitor subQueryVisitor = new ShardingCatSubQueryVisitor();
...
//				whereUnit.addSplitedExpr(expr.getRight());
    ...
    private String parseSchema(List<SQLCommentHint> hits) {
    	String regx = "\\!shardingcat:schema\\s*=([\\s\\w]*)$";
