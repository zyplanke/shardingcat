 ...
 */
public class ShardingCatStatementParser extends MySqlStatementParser
{
    private static final String LOW_PRIORITY   = "LOW_PRIORITY";
    private static final String LOCAL          = "LOCAL";
    private static final String IGNORE         = "IGNORE";
    private static final String CHARACTER      = "CHARACTER";
    public ShardingCatStatementParser(String sql)
    {
        super(sql);
        selectExprParser = new ShardingCatExprParser(sql);
    }

    public ShardingCatStatementParser(Lexer lexer)
    {
        super(lexer);
        selectExprParser = new ShardingCatExprParser(lexer);
    }
    ...
    public SQLSelectStatement parseSelect()
    {
        ...
        ShardingCatSelectParser selectParser = new ShardingCatSelectParser(this.selectExprParser);
...
//    {
//        return new ShardingCatSelectParser(this.selectExprParser);
//    }
