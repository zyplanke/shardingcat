package io.shardingcat.sequence;
...
public class DistributedSequenceHandlerTest {
    ...
    public void initialize() throws Exception {
        ...
        ShardingCatConfig shardingcatConfig = new ShardingCatConfig();
        testingServer = new TestingServer();
        testingServer.start();
        for (int i = 0; i < 16; i++) {
            distributedSequenceHandler[i] = new DistributedSequenceHandler(shardingcatConfig.getSystem());
    ...
    public void testFailOver() {
        ...
        try {
            ...
            idSet = new HashSet<>();
            ShardingCatConfig shardingcatConfig = new ShardingCatConfig();
            distributedSequenceHandler[leader] = new DistributedSequenceHandler(shardingcatConfig.getSystem());
            distributedSequenceHandler[leader].initializeZK(testingServer.getConnectString());
            distributedSequenceHandler[leader].nextId("");
            distributedSequenceHandler[leader2] = new DistributedSequenceHandler(shardingcatConfig.getSystem());
