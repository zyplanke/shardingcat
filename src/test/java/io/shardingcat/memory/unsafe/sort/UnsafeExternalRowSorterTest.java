...
public class UnsafeExternalRowSorterTest {
    ...
    public  void  testUnsafeExternalRowSorter() throws NoSuchFieldException, IllegalAccessException, IOException {
        ...
        MemoryManager memoryManager = shardingCatMemory.getResultMergeMemoryManager();
        DataNodeDiskManager blockManager = shardingCatMemory.getBlockManager();
        SerializerManager serializerManager = shardingCatMemory.getSerializerManager();
        ShardingCatPropertyConf conf = shardingCatMemory.getConf();
