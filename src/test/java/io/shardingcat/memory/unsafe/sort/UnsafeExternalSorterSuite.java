...
import io.shardingcat.memory.unsafe.memory.TestMemoryManager;
...
import io.shardingcat.memory.unsafe.storage.DataNodeFileManager;
...
import io.shardingcat.memory.unsafe.utils.sort.*;
...
public class UnsafeExternalSorterSuite {
  ...
  static final TestMemoryManager memoryManager =
    new TestMemoryManager(new ShardingCatPropertyConf().
            set("shardingcat.memory.offHeap.enabled", "false"));
  ...
  static  final ShardingCatPropertyConf conf = new ShardingCatPropertyConf();
  ...
  private final long pageSizeBytes = new ShardingCatPropertyConf().
          getSizeAsBytes("shardingcat.buffer.pageSize","4m");
