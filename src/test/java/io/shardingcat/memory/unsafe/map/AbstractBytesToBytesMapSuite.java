...
public abstract class AbstractBytesToBytesMapSuite {
  ...
  ShardingCatPropertyConf conf = new ShardingCatPropertyConf()
          .set("shardingcat.memory.offHeap.enabled", "" + useOffHeapMemoryAllocator())
          .set("shardingcat.memory.offHeap.size", "256mb");
