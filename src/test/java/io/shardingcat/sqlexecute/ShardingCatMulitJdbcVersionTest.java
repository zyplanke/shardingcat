package io.shardingcat.sqlexecute;
...
/**
 * 
 * 测试shardingcat对不同版本的mysql jdbc的兼容性
 * 
 * 
 * <p>
 * 关联issue: @see https://github.com/ShardingCatApache/ShardingCat-Server/issues/1203
 * 
 * <p>
 * <b>Note:</b> </br>
 * 1. 请将这个类放到新建的project独立运行, shardingcat pom.xml里面使用的mysql驱动会影响测试结果 </br>
...
public class ShardingCatMulitJdbcVersionTest {
	...
	public static void main(String[] args) {
		...
		jdbcVersionMap.put("mysql-connector-j-8.2.0.jar", "com.mysql.cj.jdbc.Driver");
