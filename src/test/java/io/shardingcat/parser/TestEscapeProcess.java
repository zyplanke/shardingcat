/*
 * Copyright (c) 2013, OpenCloudDB/ShardingCat and/or its affiliates. All rights
...
import io.shardingcat.server.interceptor.impl.DefaultSqlInterceptor;
...
public class TestEscapeProcess {
	...
	public void testEscapeProcess() {
		ShardingCatServer.getInstance().getConfig().getSystem().setDefaultSqlParser("fdbparser");
