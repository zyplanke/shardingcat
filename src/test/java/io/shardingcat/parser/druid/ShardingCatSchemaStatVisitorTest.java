 ...
 */
public class ShardingCatSchemaStatVisitorTest {

	/**
	 * 从注解中解析 shardingcat schema
	 */
	@Test
	public void test4() {
		String sql = "/*!shardingcat:schema = helper1 */update adm_task a set a.remark = 'test' where id=1";
		Assert.assertEquals(getSchema(sql), "helper1.");
		sql = "/*!shardingcat:schema=helper1*/update adm_task a set a.remark = 'test' where id=1";
		Assert.assertEquals(getSchema(sql), "helper1.");
		sql = "/*!shardingcat:schema=  helper1*/update adm_task a set a.remark = 'test' where id=1";
		Assert.assertEquals(getSchema(sql), "helper1.");
